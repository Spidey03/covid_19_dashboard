...
def api_wrapper(*args, **kwargs):
    ...
    # try:
    #     from covid_dashboard.views.get_day_wise_mandal_details.tests.test_case_01 \
    ...
    # try:
    #     from covid_dashboard.views.get_day_wise_mandal_details.request_response_mocks \
