...
def api_wrapper(*args, **kwargs):
    ...
    interactor = GetDistrictDailyCumulativeReport(storage=storage, presenter=presenter)
    district_daily_cumulative_report = interactor.get_district_daily_cumulative_report()
    data = json.dumps(district_daily_cumulative_report)
