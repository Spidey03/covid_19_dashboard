...
from covid_dashboard.interactors.get_daily_cumulative_report_for_district_interactor\
...
def api_wrapper(*args, **kwargs):
    ...
    try:
        response = interactor.get_daily_cumulative_report_for_district(
    ...
    # try:
    #     from covid_dashboard.views.get_district_daily_cumulative_report.tests.test_case_01 \
    ...
    # try:
    #     from covid_dashboard.views.get_district_daily_cumulative_report.request_response_mocks \
