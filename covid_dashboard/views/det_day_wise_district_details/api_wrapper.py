...
def api_wrapper(*args, **kwargs):
    ...
    # try:
    #     from covid_dashboard.views.det_day_wise_district_details.tests.test_case_01 \
    ...
    # try:
    #     from covid_dashboard.views.det_day_wise_district_details.request_response_mocks \
