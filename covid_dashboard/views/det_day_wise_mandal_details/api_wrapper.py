...
from covid_dashboard.interactors.get_day_wise_mandal_details_interactor\
    import GetDayWiseMandalDetails
...
def api_wrapper(*args, **kwargs):
    ...
    interactor = GetDayWiseMandalDetails(
    ...
    # try:
    #     from covid_dashboard.views.det_day_wise_mandal_details.tests.test_case_01 \
    ...
    # try:
    #     from covid_dashboard.views.det_day_wise_mandal_details.request_response_mocks \
